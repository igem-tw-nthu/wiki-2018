...
const Introduction = 
    <div>
        <div>We participated in iGEM's fifth International InterLaboratory Measurement Study. This study is organized by iGEM's measurement committee in an effort to establish a standardized, reliable and repeatable measurement tool for the iGEM community and the synthetic biology community as a whole. In the InterLab study of this year, our team followed InterLab_2018_Plate_Reader_Protocol (link: http://2018.igem.org/wiki/images/0/09/2018_InterLab_Plate_Reader_Protocol.pdf) to conduct the experiment.</div>
...
const Measurement =
    <div>
        ...
        <div>Secondly, two colonies from each plate were picked and inoculated in LB medium containing chloramphenicol overnight for 16-18 hours at 37°C and 220 rpm.</div>
        <div>Finally, we measured the OD600 and fluorescence of transformed cells according to the protocol after 0, 6 hours. Measurements gave us the following data and calculations which were conducted with the values we obtained from the standard curves and the reference point.</div>
    </div>
