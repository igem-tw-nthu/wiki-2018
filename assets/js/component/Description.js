...
const Reference =   
    <div>
        ...
        <div className='reference'>3. 朱惠真; 黃美瑩; 劉旭展; 曾亮瑋; 潘崇良; 張錦宜 2016 Screening Bacteria Antagonistic toward Aquatic Pathogenic Vibrio spp. from Marine Fishes and Shrimp. Journal of Taiwan Fisheries Research, 24 (1): 37-50</div>
        <div className='reference'>4. 張錦宜、吳嘉哲、林金榮. 2011. 水產病原性弧菌數檢測套組之研發. 水試專訊, 034, 36-39</div>
        <div className='reference'>5. 好菌保健康！食安少煩惱！ 黃美瑩、曾亮瑋、張錦宜/水產養殖組. 行政院農業委員會水產試驗所電子報第118期. 20160226  (link to http://www.tfrin.gov.tw/friweb/frienews/enews0118/h1.html)</div>
    </div>
