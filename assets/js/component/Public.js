...
const Eurasian = 
    <div>
        ...
        <div>
            <div>1.	The other iGEMers provided us with some useful feedbacks, for instance, they suggested us to integrate and double-check the consistency of data from our bio-reactor and Vibrio-detecting system. Also, team members from CUHK gave us some suggestions about our image detection system. Moreover, some people suggested us other switch systems for our experimental design like toehold switch. After the conference, we searched for several switch systems but we still stick to our original idea because we thought that the disadvantage for our STAR system is the least.</div>
            <div>2.	A more concise presentation should be considered. This is the first presentation after our frame was formed out, but we spent much time explaining the detailed information about our project. Furthermore, we didn’t integrate our wet lab works and dry lab works in our presentation which was not convincing to the audience. After the presentation, we then modified the whole slides into a more concise and more comprehensible version which do help more audiences to get into our story.</div>
            <div>3.	The meet-up official set up several workshops and lectures during the conference. For instance, they invited former iGEM judge and iGEM ambassador to share their experiences like “how to be an iGEMer?” from many different perspectives. It seems to us that we learned more details and tips about how to handle the iGEM project and figured out the overview of this competition.</div>
        </div>
